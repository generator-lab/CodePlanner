[T4Scaffolding.Scaffolder(Description = "Enter a description of CodePlanner.JS.KnockoutVMs.All here")][CmdletBinding()]
param(        
    [string]$Project,
	[string]$CodeLanguage,
...
$classes | ForEach{		
	...
	$_.Bases | ForEach{
		if($_.Name -eq "PersistentEntity"){							
			Scaffold CodePlanner.JS.KnockoutVM.For $current.Name -Force:$Force			
		}
