[T4Scaffolding.Scaffolder(Description = "Enter a description of CodePlanner.ViewModels.All here")][CmdletBinding()]
param(        
    [string]$Project,
	[string]$CodeLanguage,
...
$classes | ForEach{		
	...
	$_.Bases | ForEach{
		if($_.Name -eq "PersistentEntity"){							
			Scaffold CodePlanner.ViewModel.For $current.Name -Force:$Force			
		}
